...
from app.core.user import auth_backend, current_user, fastapi_users, get_user_db
...
async def get(user_id: int, session: AsyncSession = Depends(get_async_session)):
...
async def change_password(
    ...
    await db_user.update(current_user, {"hashed_password": hashed_new_password})
